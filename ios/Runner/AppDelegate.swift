...
@objc class AppDelegate: FlutterAppDelegate, FlutterStreamHandler {
    ...
    let audioChannel = FlutterMethodChannel(name: "com.shafayat.mediaPlayer/audio", binaryMessenger: controller.binaryMessenger)
                        ...
                        if let subtitle = arguments["subtitle"] as? String {
                            ...
                            if let position = arguments["position"] as? Double {
                              ...
                              if let isLiveStream = arguments["isLiveStream"] as? Bool {
                                ...
                                self.setup(title: title, subtitle: subtitle, position: position, url: audioURL, isLiveStream: isLiveStream)
                              }
                            }
                        }
                    }
        ...
        /* seek audio playback */
            ...
            if let arguments = call.arguments as? NSDictionary {
                ...
                if let seekToSecond = arguments["second"] as? Double {
                    ...
                    self.seekTo(seconds: seekToSecond)
                }
            }
    ...
    self.setupEventChannel(messenger: controller.binaryMessenger, instance: self)
    GeneratedPluginRegistrant.register(with: self)
    return super.application(application, didFinishLaunchingWithOptions: launchOptions)
    
    }
    
    private func setupEventChannel(messenger:FlutterBinaryMessenger, instance: AppDelegate) {
        
        /* register for Flutter event channel */
        instance.eventChannel = FlutterEventChannel(name: "com.shafayat.mediaPlayer/audio_event", binaryMessenger: messenger, codec: FlutterJSONMethodCodec.sharedInstance())
